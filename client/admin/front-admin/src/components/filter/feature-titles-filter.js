...
class FeatureTitleFilter extends HTMLElement {
  constructor () {
    ...
    document.addEventListener('showFeatureTitleFilter', this.showFeatureTitleFilter.bind(this))
  }
...
customElements.define('feature-titles-filter-component', FeatureTitleFilter)
