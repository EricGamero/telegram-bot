...
class LanguageFilter extends HTMLElement {
  constructor () {
    ...
    document.addEventListener('showLanguageFilter', this.showLanguageFilter.bind(this))
  }
...
customElements.define('languages-filter-component', LanguageFilter)
